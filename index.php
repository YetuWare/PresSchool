      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/spaceroon.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">Formandos</a></h4>
                <p> <strong>Turma dos Adolescentes</strong></p>
                <div>
                  <a href="assets/img/spaceroon.jpeg" class="portfolio-lightbox link-preview" data-gallery="portfolioGallery" title="Momento de formação"><i class="bi bi-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/space2.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">Alunos</a></h4>
                <p>Sala de Aula</p>
                <div>
                  <a href="assets/img/space2.jpeg" class="portfolio-lightbox link-preview" data-gallery="portfolioGallery" title="Momento de Formação"><i class="bi bi-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="assets/img/pres (1).jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">Formandas</a></h4>
                <p>Momentos</p>
                <div>
                  <a href="assets/img/pres (1).jpeg" class="portfolio-lightbox link-preview" data-gallery="portfolioGallery" ><i class="bi bi-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/pres (2).jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">Formandos</a></h4>
              
                <div>
                  <a href="assets/img/pres (2).jpeg" class="portfolio-lightbox link-preview" data-gallery="portfolioGallery" ><i class="bi bi-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/pres (4).jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">Formandos</a></h4>
                <div>
                  <a href="assets/img/pres (4).jpeg" class="portfolio-lightbox link-preview" data-gallery="portfolioGallery" ><i class="bi bi-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">Clientes</a></h4>
                
                <div>
                  <a href="assets/img/pres (5).jpeg" class="portfolio-lightbox link-preview" data-gallery="portfolioGallery" ><i class="bi bi-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
